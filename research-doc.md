...
![Алгоритм адаптации домена для модели, сегментирующей изображения](images/domain-adaptation-for-image-seg.png)

Рис 1. Алгоритм адаптации домена для модели, сегментирующей изображения
...
### 1. **Office-31**
**Office-31** - один из самых известных датасетов для domain adaptation, содержащий изображения из трех различных доменов: Изображения, собранные с сайта Amazon, Изображения, снятые с помощью веб-камеры и Изображения, снятые с помощью DSLR-камеры.

![Office-31](images/Office-31.jpg)
...
![DomainNet](images/DomainNet.jpg)

### 5. **Office-Home**
**Office-Home** - датасет для domain adaptation, содержащий изображения из четырех доменов: Художественные изображения, Клипарты, Фото продуктов, и Реальные изображения.

![Office-Home](images/Office-Home.png)
