...
![Алгоритм адаптации модели для сегментации изображений](images/domain-adaptation-for-image-seg.png)
...
### 2. **VisDA-2017**
**VisDA-2017** - большой датасет для визуальной domain adaptation, содержащий Генерированные изображения и реальные изображения.
